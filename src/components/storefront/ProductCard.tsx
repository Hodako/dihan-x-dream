...
export default function ProductCard({ product, priority = false }: ProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col bg-white rounded-xl sm:rounded-2xl border border-line-200 overflow-hidden shadow-2xs hover:shadow-md transition-all duration-300 block cursor-pointer"
