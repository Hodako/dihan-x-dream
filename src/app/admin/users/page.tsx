    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-line-200">
        <div>
          ...
          <p className="text-xs text-ink-500 mt-0.5">
            Super Admin: <strong className="text-admin-accent">azizulhakim886@outlook.com</strong>. Manage roles & permissions.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 bg-admin-accent hover:bg-admin-accent-hover text-white rounded-lg text-xs font-bold uppercase tracking-wider flex items-center gap-2 transition-colors cursor-pointer shadow-xs"
          >
      ...
      {isSuperAdmin && (
        <div className="p-4 bg-df-success-soft border border-df-success/30 rounded-2xl flex items-center gap-3 text-xs text-df-success">
          ...
          <div>
            <strong className="uppercase">Super Administrator Privileges Active:</strong> You have master access to promote, assign staff roles, or grant admin powers to any user.
          </div>
        </div>
      )}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 sm:p-8 z-50 border border-line-200 space-y-4 text-xs">
            ...
            <form onSubmit={handleCreateNewAdmin} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 bg-bg-subtle border border-line-200 rounded font-semibold"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 bg-bg-subtle border border-line-200 rounded uppercase font-bold cursor-pointer"
                >
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-line-200">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-4 py-2 bg-line-200 hover:bg-line-300 text-ink-800 rounded font-bold uppercase cursor-pointer"
                >
                  Cancel
                </button>
                <button
